...
# Finance Situational Awareness — Monitoring-Conditional Behavior Benchmark
...
ds  = load_dataset("ML0037/finance-situational-awareness")
row = ds["test"][0]
...
mt    = load_dataset("ML0037/finance-situational-awareness", "multiturn")["test"]
...
@misc{finsituawareness2026,
  ...
  year   = {2026},
  url    = {https://huggingface.co/datasets/ML0037/finance-situational-awareness}
}
```
